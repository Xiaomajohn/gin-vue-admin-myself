...
- [web/src/api/menu.js:1-142](file://web/src/api/menu.js#L1-L142)
...
- [server/model/system/response/sys_menu.go:1-16](file://server/model/system/response/sys_menu.go#L1-L16)
...
- 组件路径映射（pathInfo.json）：将组件物理路径映射为组件名，供 keep-alive 与缓存策略使用。
...
- [server/model/system/response/sys_menu.go:5-11](file://server/model/system/response/sys_menu.go#L5-L11)
...
- [web/src/pinia/modules/router.js:107-100](file://web/src/pinia/modules/router.js#L107-L100)
