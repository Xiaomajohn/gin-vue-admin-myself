...
INIT["DBList()<br/>server/initialize/db_list.go"]
end
GM --> U
GM --> API
GM --> BM
...
- [sys_authority_menu.go:12-19](file://server/model/system/sys_authority_menu.go#L12-L19)
...
- [sys_user_authority.go:1-12](file://server/model/system/sys_user_authority.go#L1-L12)
...
- [sys_authority_menu.go:1-20](file://server/model/system/sys_authority_menu.go#L1-L20)
...
CFG --> INIT
MYSQL --> INIT
INIT --> |"构建 gorm.DB"| SYS["系统库实例"]
INIT --> |"构建 gorm.DB 列表"| DBLIST["多库映射"]
```
